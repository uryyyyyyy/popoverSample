...
class Popover extends React.Component {
  ...
  _getDefaultAnimatedStyles() {
    ...
    console.log(animatedValues.translate.x)
    console.log(animatedValues.translate.y)
    console.log(animatedValues.scale)
  ...
  render() {
    ...
    console.log(styles.contentContainer)
    console.log(extendedStyles.content)
